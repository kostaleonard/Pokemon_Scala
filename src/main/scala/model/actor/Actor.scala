...
object Actor {
  ...
  val PLAYER_SOUTH = 10
  val PLAYER_SOUTH_STEP_LEFT = 11
  val PLAYER_SOUTH_STEP_RIGHT = 12
  val PLAYER_SOUTH_RUN_LEFT = 13
  val PLAYER_SOUTH_RUN_RIGHT = 14

  val PLAYER_EAST = 20
  val PLAYER_EAST_STEP_LEFT = 21
  val PLAYER_EAST_STEP_RIGHT = 22
  val PLAYER_EAST_RUN_LEFT = 23
  val PLAYER_EAST_RUN_RIGHT = 24

  val PLAYER_NORTH = 30
  val PLAYER_NORTH_STEP_LEFT = 31
  val PLAYER_NORTH_STEP_RIGHT = 32
  val PLAYER_NORTH_RUN_LEFT = 33
  val PLAYER_NORTH_RUN_RIGHT = 34

  val PLAYER_WEST = 40
  val PLAYER_WEST_STEP_LEFT = 41
  val PLAYER_WEST_STEP_RIGHT = 42
