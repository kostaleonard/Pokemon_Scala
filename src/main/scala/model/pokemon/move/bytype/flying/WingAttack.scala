package model.pokemon.move.bytype.flying

import model.elementaltype.{ElementalType, FlyingType}
...
class WingAttack extends Move {
  ...
  override def getName: String = "WING ATTACK"
  ...
  override def getDescription: String = "Strikes the foe with wings spread wide."
  ...
  override def getType: ElementalType = FlyingType
