...
class Blastoise(override protected val levelTracker: LevelTracker)
  ...
  override def getBaseStats: PokemonStats = new PokemonStats(scala.collection.immutable.Map[String, Int](
    PokemonStats.HP_KEY -> Blastoise.BASE_HP,
    PokemonStats.ATK_KEY -> Blastoise.BASE_ATK,
    PokemonStats.DEF_KEY -> Blastoise.BASE_DEF,
    PokemonStats.SPATK_KEY -> Blastoise.BASE_SPATK,
    PokemonStats.SPDEF_KEY -> Blastoise.BASE_SPDEF,
    PokemonStats.SPD_KEY -> Blastoise.BASE_SPD
  ))
  ...
  override def getBaseExpAwarded: Int = 210
}
